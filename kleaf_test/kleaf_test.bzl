...
load("//build/kernel/kleaf/artifact_tests:vendor_boot_image_test.bzl", "vendor_boot_image_test")
...
def _vendor_boot_test(name, kernel_build, kernel_modules_install, **private_kwargs):
    initramfs(
